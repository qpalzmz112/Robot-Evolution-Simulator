...
The kinematic chain consists of 5 to 15 links. Each link has its x, y, and z dimensions chosen randomly between 0.1 and an upper bound. 
The upper bound is chosen randomly between 0.5 and 2. 
