...
def Send_Cube(name="default",pos=[0,0,0],size=[1,1,1], mass=1.0, color="cyan"):
    Send_Link(name,pos,size,"box",mass,color)

def Send_Sphere(name="default",pos=[0,0,0],size=[0.5], mass=1.0,color="cyan"):
    Send_Link(name,pos,size,"sphere", mass,color)

def Send_Link(name,pos,size,objectType,mass,color):
